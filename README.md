...
> Answer: The page won't refresh, so less data is processed and routing is faster

- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript And XML

- [ ] What are `controlled components` in React?
> Answer: The component that renders the controlled component controls what happens to that component on subsequent user input
